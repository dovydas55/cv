...
\outerlist{
	...
	\innerlist{
		...
		Key responsibilities include; Distributed caching strategies, microservice syncronization, solving scalability issues, metric collection and processing for identifyng performance bottlenecks, 
		database query optimization, defining error domains and error recovery strategies, building integrations against 3rd party services.
		}
	}
