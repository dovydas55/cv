...
\outerlist{
	...
	\innerlist{
		...
		Key challenges include, distributed caching strategies, microservice syncronization, metric collection for identifyng bottlenecks, 
		database query optimization, defining error domains and error recovery.
		}
	}
	...
	\innerlist{
		...
		Large focus on software security, hsm encription, database optimization, developing restful apis.}
	}
